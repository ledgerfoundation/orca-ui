...
contract OrcaPodManager is ERC1155Receiver {
    ...
    function claimMembership(uint256 _podId) public {
        ...
        require(rulebook.isRuleCompliant(_podId, msg.sender), 'Not Rule Compliant');

        memberToken.safeTransferFrom(address(this), msg.sender, _podId, 1, bytes(''));
    }
    ...
    function retractMembership(uint256 _podId, address _member) public {
        ...
        memberToken.safeTransferFrom(_member, address(this), _podId, 1, 'non-compliant');
    }
